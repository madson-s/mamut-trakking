...
import { ArrowRightIcon, Button, CaretDownIcon, Container, Heading, Text } from '@/components/ui';
...
import { AdventureCard, aventurasDoIdioma, type Adventure } from './AdventureCard';
