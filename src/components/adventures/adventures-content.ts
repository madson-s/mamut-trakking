...
export const ADVENTURES_CONTENT: Record<Locale, AdventuresContent> = {
  pt: {
    ...
    roteiros: {
      ...
      'mirante-do-pati-1-dia': { title: 'Mirante do Pati 1 Dia', difficulty: 'Fácil' },
  ...
  en: {
    ...
    roteiros: {
      ...
      'mirante-do-pati-1-dia': { title: 'Pati Viewpoint 1 Day', difficulty: 'Easy' },
  ...
  es: {
    ...
    roteiros: {
      ...
      'mirante-do-pati-1-dia': { title: 'Mirador del Pati 1 Día', difficulty: 'Fácil' },
