...
export const ADVENTURES: AdventureBase[] = [
  // Ordem espelhada de mamut.agency/aventuras — o hub renderiza na ordem do
  // array, então é aqui que a vitrine é curada. Mexer só para acompanhar a
  // referência; não é ordenação alfabética nem por preço.
  ...
  { id: 'parque-da-muritiba', category: 'day-tour', route: 'muritiba', image: '/img/adventures/muritiba/hero.jpeg', duration: 1, difficultyGroup: 'Fácil', distance: '4 km', location: 'Lençóis', price: 160 },
  { id: 'fazenda-pratinha-gruta-azul', category: 'day-tour', route: 'pratinha', image: '/img/adventures/pratinha/hero.jpeg', duration: 1, difficultyGroup: 'Fácil', distance: '100 m', location: 'Iraquara', price: 500 },
  { id: 'aguas-claras', category: 'day-tour', route: 'aguas-claras-1d', image: '/img/adventures/aguas-claras-1d/hero.jpeg', duration: 1, difficultyGroup: 'Fácil', distance: '18 km', location: 'Lençóis', price: 390 },
