  ...
  return (
    <>
      <div id="galeria" className="grid gap-4 sm:grid-cols-[1.7fr_1fr]">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-1 sm:grid-rows-[1fr_1fr_auto]">
          {[1, 2].map((index) => (
          ...
          <Button href="/pt/aventuras/vale-do-pati-3-dias/galeria" variant="outline" size="lg" block>Ver todas as fotos</Button>
        </div>
      </div>
