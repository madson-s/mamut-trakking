...
const CONTENT = DICAS_CONTENT.en.paginas['classificacao-de-nivel'];

export const metadata: Metadata = {
  title: CONTENT.meta.title,
  description: CONTENT.meta.description,
  alternates: {
    canonical: '/en/level-classification',
...
export default function ClassificacaoRoute() {
  return (
    <DicasLayout locale="en" pagina="classificacao-de-nivel">
      <ClassificacaoDeNivel locale="en" />
    </DicasLayout>
  );
}
