...
const CONTENT = MARIMBUS_CONTENT.en;
...
export default function MarimbusEnRoute() {
  return <DayTourExperience locale="en" content={MARIMBUS_CONTENT} assets={MARIMBUS_ASSETS} />;
}
