...
const CONTENT = CACHOEIRAO_CONTENT.en;
...
export default function CachoeiraoEnRoute() {
  return <DayTourExperience locale="en" content={CACHOEIRAO_CONTENT} assets={CACHOEIRAO_ASSETS} />;
}
