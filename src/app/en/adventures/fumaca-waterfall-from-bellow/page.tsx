...
const CONTENT = FUMACA_BAIXO_CONTENT.en;
...
export default function FumacaBaixoEnRoute() {
  return <DayTourExperience locale="en" content={FUMACA_BAIXO_CONTENT} assets={FUMACA_BAIXO_ASSETS} />;
}
