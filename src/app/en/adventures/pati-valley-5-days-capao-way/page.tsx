...
const CONTENT = PATI_5_CAPAO_CONTENT.en;
...
export default function Pati5CapaoEnRoute() {
  return <DayTourExperience locale="en" content={PATI_5_CAPAO_CONTENT} assets={PATI_5_CAPAO_ASSETS} />;
}
