...
const CONTENT = FUMACA_360_CONTENT.en;
...
export default function Fumaca360EnRoute() {
  return <DayTourExperience locale="en" content={FUMACA_360_CONTENT} assets={FUMACA_360_ASSETS} />;
}
