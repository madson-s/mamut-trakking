...
const CONTENT = MIRANTE_PATI_CONTENT.pt;
...
export default function MirantePatiPtRoute() {
  return <DayTourExperience locale="pt" content={MIRANTE_PATI_CONTENT} assets={MIRANTE_PATI_ASSETS} />;
}
