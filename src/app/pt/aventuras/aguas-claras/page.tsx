...
const CONTENT = AGUAS_CLARAS_1D_CONTENT.pt;
...
export default function AguasClaras1dPtRoute() {
  return <DayTourExperience locale="pt" content={AGUAS_CLARAS_1D_CONTENT} assets={AGUAS_CLARAS_1D_ASSETS} />;
}
