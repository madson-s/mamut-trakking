...
const CONTENT = FERRADURA_CONTENT.pt;
...
export default function FerraduraPtRoute() {
  return <DayTourExperience locale="pt" content={FERRADURA_CONTENT} assets={FERRADURA_ASSETS} />;
}
