...
const CONTENT = FUMACINHA_CONTENT.pt;
...
export default function FumacinhaPtRoute() {
  return <DayTourExperience locale="pt" content={FUMACINHA_CONTENT} assets={FUMACINHA_ASSETS} />;
}
