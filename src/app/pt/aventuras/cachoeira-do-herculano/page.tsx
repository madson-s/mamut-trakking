...
const CONTENT = HERCULANO_CONTENT.pt;
...
export default function HerculanoPtRoute() {
  return <DayTourExperience locale="pt" content={HERCULANO_CONTENT} assets={HERCULANO_ASSETS} />;
}
