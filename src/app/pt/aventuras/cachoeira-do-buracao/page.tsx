...
const CONTENT = BURACAO_CONTENT.pt;
...
export default function BuracaoPtRoute() {
  return <DayTourExperience locale="pt" content={BURACAO_CONTENT} assets={BURACAO_ASSETS} />;
}
