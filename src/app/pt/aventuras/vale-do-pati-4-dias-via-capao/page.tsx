...
const CONTENT = PATI_4_CAPAO_CONTENT.pt;
...
export default function Pati4CapaoPtRoute() {
  return <DayTourExperience locale="pt" content={PATI_4_CAPAO_CONTENT} assets={PATI_4_CAPAO_ASSETS} />;
}
