...
const CONTENT = MURITIBA_CONTENT.pt;
...
export default function MuritibaPtRoute() {
  return <DayTourExperience locale="pt" content={MURITIBA_CONTENT} assets={MURITIBA_ASSETS} />;
}
