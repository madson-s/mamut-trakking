...
const CONTENT = MARIMBUS_CONTENT.pt;
...
export default function MarimbusPtRoute() {
  return <DayTourExperience locale="pt" content={MARIMBUS_CONTENT} assets={MARIMBUS_ASSETS} />;
}
