...
const CONTENT = PRATINHA_CONTENT.pt;
...
export default function PratinhaPtRoute() {
  return <DayTourExperience locale="pt" content={PRATINHA_CONTENT} assets={PRATINHA_ASSETS} />;
}
