...
const CONTENT = CITY_TOUR_CONTENT.pt;
...
export default function CityTourPtRoute() {
  return <DayTourExperience locale="pt" content={CITY_TOUR_CONTENT} assets={CITY_TOUR_ASSETS} />;
}
