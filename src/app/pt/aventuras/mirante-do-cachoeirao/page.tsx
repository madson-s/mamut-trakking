...
const CONTENT = CACHOEIRAO_CONTENT.pt;
...
export default function CachoeiraoPtRoute() {
  return <DayTourExperience locale="pt" content={CACHOEIRAO_CONTENT} assets={CACHOEIRAO_ASSETS} />;
}
