...
const CONTENT = PALMITAL_CONTENT.es;
...
export default function PalmitalEsRoute() {
  return <DayTourExperience locale="es" content={PALMITAL_CONTENT} assets={PALMITAL_ASSETS} />;
}
