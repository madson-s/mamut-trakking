...
const CONTENT = PATI_5_CAPAO_CONTENT.es;
...
export default function Pati5CapaoEsRoute() {
  return <DayTourExperience locale="es" content={PATI_5_CAPAO_CONTENT} assets={PATI_5_CAPAO_ASSETS} />;
}
