...
const CONTENT = HERCULANO_CONTENT.es;
...
export default function HerculanoEsRoute() {
  return <DayTourExperience locale="es" content={HERCULANO_CONTENT} assets={HERCULANO_ASSETS} />;
}
