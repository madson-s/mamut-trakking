...
const CONTENT = MOSQUITO_PAI_INACIO_CONTENT.es;
...
export default function MosquitoPaiInacioEsRoute() {
  return <DayTourExperience locale="es" content={MOSQUITO_PAI_INACIO_CONTENT} assets={MOSQUITO_PAI_INACIO_ASSETS} />;
}
