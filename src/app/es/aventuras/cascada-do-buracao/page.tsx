...
const CONTENT = BURACAO_CONTENT.es;
...
export default function BuracaoEsRoute() {
  return <DayTourExperience locale="es" content={BURACAO_CONTENT} assets={BURACAO_ASSETS} />;
}
