...
const CONTENT = FUMACA_BAIXO_CONTENT.es;
...
export default function FumacaBaixoEsRoute() {
  return <DayTourExperience locale="es" content={FUMACA_BAIXO_CONTENT} assets={FUMACA_BAIXO_ASSETS} />;
}
