...
const CONTENT = CITY_TOUR_CONTENT.es;
...
export default function CityTourEsRoute() {
  return <DayTourExperience locale="es" content={CITY_TOUR_CONTENT} assets={CITY_TOUR_ASSETS} />;
}
