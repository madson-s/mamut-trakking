...
const CONTENT = FUMACINHA_CONTENT.es;
...
export default function FumacinhaEsRoute() {
  return <DayTourExperience locale="es" content={FUMACINHA_CONTENT} assets={FUMACINHA_ASSETS} />;
}
