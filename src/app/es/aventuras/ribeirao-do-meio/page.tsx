...
const CONTENT = RIBEIRAO_CONTENT.es;
...
export default function RibeiraoEsRoute() {
  return <DayTourExperience locale="es" content={RIBEIRAO_CONTENT} assets={RIBEIRAO_ASSETS} />;
}
