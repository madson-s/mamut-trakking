...
const CONTENT = FUMACA_360_CONTENT.es;
...
export default function Fumaca360EsRoute() {
  return <DayTourExperience locale="es" content={FUMACA_360_CONTENT} assets={FUMACA_360_ASSETS} />;
}
