...
const CONTENT = PATI_4_CAPAO_CONTENT.es;
...
export default function Pati4CapaoEsRoute() {
  return <DayTourExperience locale="es" content={PATI_4_CAPAO_CONTENT} assets={PATI_4_CAPAO_ASSETS} />;
}
