...
const CONTENT = MIRANTE_PATI_CONTENT.es;
...
export default function MirantePatiEsRoute() {
  return <DayTourExperience locale="es" content={MIRANTE_PATI_CONTENT} assets={MIRANTE_PATI_ASSETS} />;
}
