...
const CONTENT = MURITIBA_CONTENT.es;
...
export default function MuritibaEsRoute() {
  return <DayTourExperience locale="es" content={MURITIBA_CONTENT} assets={MURITIBA_ASSETS} />;
}
