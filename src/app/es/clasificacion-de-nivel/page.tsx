...
const CONTENT = DICAS_CONTENT.es.paginas['classificacao-de-nivel'];

export const metadata: Metadata = {
  title: CONTENT.meta.title,
  description: CONTENT.meta.description,
  alternates: {
    canonical: '/es/clasificacion-de-nivel',
...
export default function ClassificacaoRoute() {
  return (
    <DicasLayout locale="es" pagina="classificacao-de-nivel">
      <ClassificacaoDeNivel locale="es" />
    </DicasLayout>
  );
}
